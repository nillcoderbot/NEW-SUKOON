...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("HINDI_ENGLISH_CHATS_CHATTING")
                await self.one.join_chat("HINDI_ENGLISH_CHATS_CHATTING")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("HINDI_ENGLISH_CHATS_CHATTING")
                await self.two.join_chat("HINDI_ENGLISH_CHATS_CHATTING")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("HINDI_ENGLISH_CHATS_CHATTING")
                await self.three.join_chat("HINDI_ENGLISH_CHATS_CHATTING")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("HINDI_ENGLISH_CHATS_CHATTING")
                await self.four.join_chat("HINDI_ENGLISH_CHATS_CHATTING")
            except:
                pass
            assistants.append(4)
